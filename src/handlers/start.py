...
async def menu_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_img":
        await query.edit_message_text(
            ...
            f"💡 Custo: 🪙 {COST_PER_IMAGE} coin por imagem",
            parse_mode="Markdown",
        )
        ...
        await query.edit_message_text(
            ...
            f"💡 Custo:\n"
            f"• 4 segundos: 🪙 {COST_PER_VIDEO_4S} coins\n"
            f"• 8 segundos: 🪙 {COST_PER_VIDEO_8S} coins\n\n"
            "💬 Use: `/video 4s <descrição>` ou `/video 8s <descrição>`",
            parse_mode="Markdown",
        )
